...
if(@$_GET['id']){
  ...
  foreach($data as $key=>$value){
	...
	$isi["keterangan"] = $value["pcerai_keterangan"]; 
    $isi['edit']='<center><a href="javascript:;" id="'.$value['pcerai_id'].'" onclick="edit(this.id)"><i class="dw dw-edit2" style="font-size:20px" data-toggle="modal" data-target="#modal"></i></a></center>';
    $isi['hapus']='<center><a href="javascript:;" id="'.$value['pcerai_id'].'" onclick="return hapus(this.id)"><i class="dw dw-delete-3" style="font-size:20px"></i></a></center>';
