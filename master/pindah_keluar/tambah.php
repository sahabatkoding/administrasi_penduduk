...
$header = "Tambah Data Pindah Datang";
				...
				<div class="card mb-30 row col-md-8">
					...
					<div class="p-4">
						...
						<div class="form-group">
							...
							<input type="date" value="<?= date('Y-m-d') ?>" class="form-control" required="" name="tgl_pindah">
						</div>
						<div class="form-group">
							...
							<select required="" class="form-control custom-select2" name="nik">
								...
								<?php foreach ($penduduk as $key => $value): ?>
									<option value="<?= $value['nik'] ?>"><?= $value['penduduk_nama'] ?> | <?= $value['nik'] ?></option>
								<?php endforeach ?>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" required="" class="form-control" name="alamat_pindah">
						</div>
						<div class="form-group">
							<label>Alasan Pindah</label>
							<input type="text" required="" class="form-control" name="alasan_pindah">
						</div>
						<div class="form-group">
