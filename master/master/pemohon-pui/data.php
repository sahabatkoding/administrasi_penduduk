...
if(isset($_GET['id'])){
  ...
  foreach($data as $key=>$value){
    ...
    $isi['tempat_lahir']=$value['pemohon_tempat_lahir'].", ".tgl_indo($value['pemohon_tanggal_lahir']);
   $isi['jk']=$value['pemohon_jk'];
    ...
    $isi['tgl_reg']=tgl_indo2(pecah($value['tgl_reg'])); 
    $isi['tgl_update']=tgl_indo2(pecah($value['tgl_update']));
